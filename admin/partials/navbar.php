      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Olá, <span class="text-black fw-bold"><?php echo $uss_name;?></span></h1>
            <h3 class="welcome-sub-text">CARGO: <?php echo $uss_role; ?> | RANK: <?php echo $uss_rank; ?></h3>
          </li>
        </ul>
