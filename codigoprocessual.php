  ...
  <p></p>
      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <br>
          <p>⚖️ <strong>Art. 20</strong> Proceder à busca pessoal quando houver fundada suspeita de que alguém oculte consigo arma proibida ou objetos mencionados nos incisos II a VI e inciso VIII do parágrafo anterior.</p>
          <br>
        ...
        <div class="col-12">
          ...
          <br>
          <p>Prefeito</p>
          <p>Presidente do Tribunal</p>
          <p>Vereador</p>
          <p>Comandantes de Polícia e Delegados</p>
          <br>
          <p>⚖️ <strong>Art. 45</strong> Fica vedado a prisão ou detenção dos portadores destes títulos sem autorização expressa do Juiz, salvo em casos de prisão em flagrante de crimes hediondos.</p>
          <br>
          <p>⚖️ <strong>Art. 46</strong> Os comandantes de Polícia e Delegados podem ser presos caso seja solicitado pela corregedoria ou Tribunal Militar independente de ordens do Juiz.</p>
          <br>
